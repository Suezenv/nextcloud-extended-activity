(function() {
  ...
  try {
    if (typeof document != "undefined") {
      ...
      elementStyle.appendChild(document.createTextNode('/**\n * SPDX-FileCopyrightText: 2019 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/**\n * SPDX-FileCopyrightText: 2021 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/*\n* Ensure proper alignment of the vue material icons\n*/\n.material-design-icon {\n  display: flex;\n  align-self: center;\n  justify-self: center;\n  align-items: center;\n  justify-content: center;\n}\n#skip-actions.vue-skip-actions:focus-within {\n  top: 0 !important;\n  inset-inline-start: 0 !important;\n  width: 100vw;\n  height: 100vh;\n  padding: var(--body-container-margin) !important;\n  backdrop-filter: brightness(50%);\n}/**\n * SPDX-FileCopyrightText: 2019 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/**\n * SPDX-FileCopyrightText: 2021 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/*\n* Ensure proper alignment of the vue material icons\n*/\n.material-design-icon[data-v-50a8547c] {\n  display: flex;\n  align-self: center;\n  justify-self: center;\n  align-items: center;\n  justify-content: center;\n}\n.vue-skip-actions__container[data-v-50a8547c] {\n  background-color: var(--color-main-background);\n  border-radius: var(--border-radius-large);\n  padding: 22px;\n}\n.vue-skip-actions__headline[data-v-50a8547c] {\n  font-weight: bold;\n  font-size: 20px;\n  line-height: 30px;\n  margin-bottom: 12px;\n}\n.vue-skip-actions__buttons[data-v-50a8547c] {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 12px;\n}\n.vue-skip-actions__buttons[data-v-50a8547c] > * {\n  flex: 1 0 fit-content;\n}\n.vue-skip-actions__image[data-v-50a8547c] {\n  margin-top: 12px;\n}\n.content[data-v-50a8547c] {\n  display: flex;\n  width: calc(100% - var(--body-container-margin) * 2);\n  border-radius: var(--body-container-radius);\n  height: var(--body-height);\n  overflow: hidden;\n  padding: 0;\n}\n.content[data-v-50a8547c]:not(.with-sidebar--full) {\n  position: fixed;\n}\n.content[data-v-50a8547c], .content[data-v-50a8547c] * {\n  box-sizing: border-box;\n}/**\n * SPDX-FileCopyrightText: 2019 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/**\n * SPDX-FileCopyrightText: 2021 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/*\n* Ensure proper alignment of the vue material icons\n*/\n.material-design-icon[data-v-fd81a9f4] {\n  display: flex;\n  align-self: center;\n  justify-self: center;\n  align-items: center;\n  justify-content: center;\n}\n.app-details-toggle[data-v-fd81a9f4] {\n  position: sticky;\n  width: var(--default-clickable-area);\n  height: var(--default-clickable-area);\n  padding: calc((var(--default-clickable-area) - 16px) / 2);\n  cursor: pointer;\n  opacity: 0.6;\n  transform: rotate(180deg);\n  background-color: var(--color-main-background);\n  z-index: 2000;\n  top: var(--app-navigation-padding);\n  inset-inline-start: calc(var(--default-clickable-area) + var(--app-navigation-padding) * 2);\n}\n.app-details-toggle--mobile[data-v-fd81a9f4] {\n  inset-inline-start: var(--app-navigation-padding);\n}\n.app-details-toggle[data-v-fd81a9f4]:active, .app-details-toggle[data-v-fd81a9f4]:hover, .app-details-toggle[data-v-fd81a9f4]:focus {\n  opacity: 1;\n}/**\n * SPDX-FileCopyrightText: 2019 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/**\n * SPDX-FileCopyrightText: 2021 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/*\n* Ensure proper alignment of the vue material icons\n*/\n.material-design-icon[data-v-3a1a29de] {\n  display: flex;\n  align-self: center;\n  justify-self: center;\n  align-items: center;\n  justify-content: center;\n}\n.app-content[data-v-3a1a29de] {\n  position: initial;\n  z-index: 1000;\n  flex-basis: 100vw;\n  height: 100%;\n  margin: 0 !important;\n  background-color: var(--color-main-background);\n  min-width: 0;\n}\n.app-content[data-v-3a1a29de]:not(.app-content--has-list) {\n  overflow: auto;\n}\n.app-content-wrapper[data-v-3a1a29de] {\n  position: relative;\n  width: 100%;\n  height: 100%;\n}\n.app-content-wrapper--no-split.app-content-wrapper--show-list[data-v-3a1a29de]  .app-content-list {\n  display: flex;\n}\n.app-content-wrapper--no-split.app-content-wrapper--show-list[data-v-3a1a29de]  .app-content-details {\n  display: none;\n}\n.app-content-wrapper--no-split.app-content-wrapper--show-details[data-v-3a1a29de]  .app-content-list {\n  display: none;\n}\n.app-content-wrapper--no-split.app-content-wrapper--show-details[data-v-3a1a29de]  .app-content-details {\n  display: block;\n}\n[data-v-3a1a29de] .splitpanes.default-theme .app-content-list {\n  max-width: none;\n  /* Thin scrollbar is hard to catch on resizable columns */\n  scrollbar-width: auto;\n}\n[data-v-3a1a29de] .splitpanes.default-theme .splitpanes__pane {\n  background-color: transparent;\n  transition: none;\n}\n[data-v-3a1a29de] .splitpanes.default-theme .splitpanes__pane-list {\n  min-width: 300px;\n  position: sticky;\n}\n@media only screen and (width < 1024px) {\n[data-v-3a1a29de] .splitpanes.default-theme .splitpanes__pane-list {\n    display: none;\n}\n}\n[data-v-3a1a29de] .splitpanes.default-theme .splitpanes__pane-details {\n  overflow-y: auto;\n}\n@media only screen and (width < 1024px) {\n[data-v-3a1a29de] .splitpanes.default-theme .splitpanes__pane-details {\n    min-width: 100%;\n}\n}\n[data-v-3a1a29de] .splitpanes.default-theme .splitpanes__splitter {\n  background-color: var(--color-main-background);\n}\n[data-v-3a1a29de] .splitpanes.default-theme .splitpanes__splitter::before,[data-v-3a1a29de] .splitpanes.default-theme .splitpanes__splitter::after {\n  background-color: var(--color-border);\n}\n[data-v-3a1a29de] .splitpanes.default-theme.splitpanes--vertical .splitpanes__splitter {\n  border-inline-start: 1px solid var(--color-border);\n}\n[data-v-3a1a29de] .splitpanes.default-theme.splitpanes--horizontal .splitpanes__splitter {\n  border-top: 1px solid var(--color-border);\n}\n.app-content-wrapper--show-list[data-v-3a1a29de] .app-content-list {\n  max-width: none;\n}.splitpanes{display:flex;width:100%;height:100%}.splitpanes--vertical{flex-direction:row}.splitpanes--horizontal{flex-direction:column}.splitpanes--dragging .splitpanes__pane,*:has(.splitpanes--dragging){-webkit-user-select:none;user-select:none;pointer-events:none}.splitpanes__pane{width:100%;height:100%;overflow:hidden}.splitpanes--vertical .splitpanes__pane{transition:width .2s ease-out;will-change:width}.splitpanes--horizontal .splitpanes__pane{transition:height .2s ease-out;will-change:height}.splitpanes--dragging .splitpanes__pane{transition:none}.splitpanes__splitter{touch-action:none}.splitpanes--vertical>.splitpanes__splitter{min-width:1px;cursor:col-resize}.splitpanes--horizontal>.splitpanes__splitter{min-height:1px;cursor:row-resize}.default-theme.splitpanes .splitpanes__pane{background-color:#f2f2f2}.default-theme.splitpanes .splitpanes__splitter{background-color:#fff;box-sizing:border-box;position:relative;flex-shrink:0}.default-theme.splitpanes .splitpanes__splitter:before,.default-theme.splitpanes .splitpanes__splitter:after{content:"";position:absolute;top:50%;left:50%;background-color:#00000026;transition:background-color .3s}.default-theme.splitpanes .splitpanes__splitter:hover:before,.default-theme.splitpanes .splitpanes__splitter:hover:after{background-color:#00000040}.default-theme.splitpanes .splitpanes__splitter:first-child{cursor:auto}.default-theme.splitpanes .splitpanes .splitpanes__splitter{z-index:1}.default-theme.splitpanes--vertical>.splitpanes__splitter,.default-theme .splitpanes--vertical>.splitpanes__splitter{width:7px;border-left:1px solid #eee;margin-left:-1px}.default-theme.splitpanes--vertical>.splitpanes__splitter:before,.default-theme.splitpanes--vertical>.splitpanes__splitter:after,.default-theme .splitpanes--vertical>.splitpanes__splitter:before,.default-theme .splitpanes--vertical>.splitpanes__splitter:after{transform:translateY(-50%);width:1px;height:30px}.default-theme.splitpanes--vertical>.splitpanes__splitter:before,.default-theme .splitpanes--vertical>.splitpanes__splitter:before{margin-left:-2px}.default-theme.splitpanes--vertical>.splitpanes__splitter:after,.default-theme .splitpanes--vertical>.splitpanes__splitter:after{margin-left:1px}.default-theme.splitpanes--horizontal>.splitpanes__splitter,.default-theme .splitpanes--horizontal>.splitpanes__splitter{height:7px;border-top:1px solid #eee;margin-top:-1px}.default-theme.splitpanes--horizontal>.splitpanes__splitter:before,.default-theme.splitpanes--horizontal>.splitpanes__splitter:after,.default-theme .splitpanes--horizontal>.splitpanes__splitter:before,.default-theme .splitpanes--horizontal>.splitpanes__splitter:after{transform:translate(-50%);width:30px;height:1px}.default-theme.splitpanes--horizontal>.splitpanes__splitter:before,.default-theme .splitpanes--horizontal>.splitpanes__splitter:before{margin-top:-2px}.default-theme.splitpanes--horizontal>.splitpanes__splitter:after,.default-theme .splitpanes--horizontal>.splitpanes__splitter:after{margin-top:1px}\n.activity-group__heading[data-v-c27bd1ea] {\n  line-height: 1.5;\n  margin-block: 30px 12px;\n}\n.activity-group__heading[data-v-c27bd1ea]:first-of-type {\n  margin-block-start: 0;\n}.extended_activity-app[data-v-8f0835f4] {\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n}\n.extended_activity-app__empty-content[data-v-8f0835f4] {\n  height: 100%;\n}\n.extended_activity-app__loading-indicator[data-v-8f0835f4] {\n  color: var(--color-text-maxcontrast);\n  justify-self: center;\n  margin-block: 30px 6px;\n  text-align: center;\n}\n.extended_activity-app__container[data-v-8f0835f4] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  width: min(100%, 924px);\n  max-width: 924px;\n  margin: 0 auto;\n  padding-inline: 12px;\n  overflow-y: scroll;\n}\n.extended_activity-app__heading[data-v-8f0835f4] {\n  font-weight: bold;\n  font-size: 20px;\n  line-height: 44px;\n  margin-top: 1px;\n  margin-inline: calc(2 * var(--app-navigation-padding, 8px) + 44px) var(--app-navigation-padding, 8px);\n}/**\n * SPDX-FileCopyrightText: 2019 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/**\n * SPDX-FileCopyrightText: 2021 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/*\n* Ensure proper alignment of the vue material icons\n*/\n.material-design-icon {\n  display: flex;\n  align-self: center;\n  justify-self: center;\n  align-items: center;\n  justify-content: center;\n}\n.app-navigation,\n.app-content {\n  /** Distance of the app navigation toggle and the first navigation item to the top edge of the app content container */\n  --app-navigation-padding: calc(var(--default-grid-baseline, 4px) * 2);\n}/**\n * SPDX-FileCopyrightText: 2019 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/**\n * SPDX-FileCopyrightText: 2021 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/*\n* Ensure proper alignment of the vue material icons\n*/\n.material-design-icon[data-v-a249486e] {\n  display: flex;\n  align-self: center;\n  justify-self: center;\n  align-items: center;\n  justify-content: center;\n}\n.app-navigation[data-v-a249486e] {\n  --color-text-maxcontrast: var(--color-text-maxcontrast-background-blur, var(--color-text-maxcontrast-default));\n  transition: transform var(--animation-quick), margin var(--animation-quick);\n  width: 300px;\n  --app-navigation-max-width: calc(100vw - (var(--app-navigation-padding) + var(--default-clickable-area) + var(--default-grid-baseline)));\n  max-width: var(--app-navigation-max-width);\n  position: relative;\n  top: 0;\n  inset-inline-start: 0;\n  padding: 0px;\n  z-index: 1800;\n  height: 100%;\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n  flex-grow: 0;\n  flex-shrink: 0;\n  background-color: var(--color-main-background-blur, var(--color-main-background));\n  -webkit-backdrop-filter: var(--filter-background-blur, none);\n  backdrop-filter: var(--filter-background-blur, none);\n}\n.app-navigation--close[data-v-a249486e] {\n  margin-inline-start: calc(-1 * min(300px, var(--app-navigation-max-width)));\n}\n.app-navigation__search[data-v-a249486e] {\n  width: 100%;\n}\n.app-navigation__body[data-v-a249486e] {\n  overflow-y: scroll;\n}\n.app-navigation__content > ul[data-v-a249486e] {\n  position: relative;\n  width: 100%;\n  overflow-x: hidden;\n  overflow-y: auto;\n  display: flex;\n  flex-direction: column;\n  gap: var(--default-grid-baseline, 4px);\n  padding: var(--app-navigation-padding);\n}\n.app-navigation .app-navigation__list[data-v-a249486e] {\n  height: 100%;\n}\n.app-navigation__body--no-list[data-v-a249486e] {\n  flex: 1 1 auto;\n  overflow: auto;\n  height: 100%;\n}\n.app-navigation__content[data-v-a249486e] {\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n}\n[data-themes*=highcontrast] .app-navigation[data-v-a249486e] {\n  border-inline-end: 1px solid var(--color-border);\n}\n@media only screen and (max-width: 1024px) {\n.app-navigation[data-v-a249486e] {\n    position: absolute;\n    border-inline-end: 1px solid var(--color-border);\n}\n}\n@media only screen and (max-width: 512px) {\n.app-navigation[data-v-a249486e] {\n    z-index: 1400;\n}\n}/**\n * SPDX-FileCopyrightText: 2019 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/**\n * SPDX-FileCopyrightText: 2021 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/*\n* Ensure proper alignment of the vue material icons\n*/\n.material-design-icon[data-v-57437e4a] {\n  display: flex;\n  align-self: center;\n  justify-self: center;\n  align-items: center;\n  justify-content: center;\n}\n.app-navigation-list[data-v-57437e4a] {\n  position: relative;\n  width: 100%;\n  overflow-x: hidden;\n  overflow-y: auto;\n  display: flex;\n  flex-direction: column;\n  gap: var(--default-grid-baseline, 4px);\n  padding: var(--app-navigation-padding);\n}/**\n * SPDX-FileCopyrightText: 2019 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/**\n * SPDX-FileCopyrightText: 2021 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/*\n* Ensure proper alignment of the vue material icons\n*/\n.material-design-icon[data-v-e311a67a] {\n  display: flex;\n  align-self: center;\n  justify-self: center;\n  align-items: center;\n  justify-content: center;\n}\n.app-navigation-toggle-wrapper[data-v-e311a67a] {\n  position: absolute;\n  top: var(--app-navigation-padding);\n  inset-inline-end: calc(0px - var(--app-navigation-padding));\n  margin-inline-end: calc(-1 * var(--default-clickable-area));\n}\nbutton.app-navigation-toggle[data-v-e311a67a] {\n  background-color: var(--color-main-background);\n}/**\n * SPDX-FileCopyrightText: 2019 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/**\n * SPDX-FileCopyrightText: 2021 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/*\n* Ensure proper alignment of the vue material icons\n*/\n.material-design-icon[data-v-a22b5c4b] {\n  display: flex;\n  align-self: center;\n  justify-self: center;\n  align-items: center;\n  justify-content: center;\n}\n.button-vue.icon-collapse[data-v-a22b5c4b] {\n  position: relative;\n  z-index: 105;\n  color: var(--color-main-text);\n  inset-inline-end: 0;\n}\n.button-vue.icon-collapse--open[data-v-a22b5c4b] {\n  color: var(--color-main-text);\n}\n.button-vue.icon-collapse--open[data-v-a22b5c4b]:hover {\n  color: var(--color-primary-element);\n}/**\n * SPDX-FileCopyrightText: 2019 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/**\n * SPDX-FileCopyrightText: 2021 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/*\n* Ensure proper alignment of the vue material icons\n*/\n.material-design-icon[data-v-995ba421] {\n  display: flex;\n  align-self: center;\n  justify-self: center;\n  align-items: center;\n  justify-content: center;\n}\n\n/**\n * SPDX-FileCopyrightText: 2023 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n.app-navigation-entry[data-v-995ba421] {\n  position: relative;\n  display: flex;\n  flex-shrink: 0;\n  flex-wrap: wrap;\n  width: 100%;\n  min-height: var(--default-clickable-area);\n  transition: background-color var(--animation-quick) ease-in-out;\n  transition: background-color 200ms ease-in-out;\n  border-radius: var(--border-radius-element, var(--border-radius-pill));\n  /* hide deletion/collapse of subitems */\n}\n.app-navigation-entry-wrapper[data-v-995ba421] {\n  position: relative;\n  display: flex;\n  flex-shrink: 0;\n  flex-wrap: wrap;\n  width: 100%;\n}\n.app-navigation-entry-wrapper.app-navigation-entry--collapsible:not(.app-navigation-entry--opened) > ul[data-v-995ba421] {\n  display: none;\n}\n.app-navigation-entry.active[data-v-995ba421] {\n  background-color: var(--color-primary-element) !important;\n}\n.app-navigation-entry.active[data-v-995ba421]:hover {\n  background-color: var(--color-primary-element-hover) !important;\n}\n.app-navigation-entry.active .app-navigation-entry-link[data-v-995ba421], .app-navigation-entry.active .app-navigation-entry-button[data-v-995ba421] {\n  color: var(--color-primary-element-text) !important;\n}\n.app-navigation-entry[data-v-995ba421]:focus-within, .app-navigation-entry[data-v-995ba421]:hover {\n  background-color: var(--color-background-hover);\n}\n.app-navigation-entry.active .app-navigation-entry__children[data-v-995ba421], .app-navigation-entry:focus-within .app-navigation-entry__children[data-v-995ba421], .app-navigation-entry:hover .app-navigation-entry__children[data-v-995ba421] {\n  background-color: var(--color-main-background);\n}\n.app-navigation-entry.active .app-navigation-entry__utils .app-navigation-entry__actions[data-v-995ba421], .app-navigation-entry.app-navigation-entry--deleted .app-navigation-entry__utils .app-navigation-entry__actions[data-v-995ba421], .app-navigation-entry:focus .app-navigation-entry__utils .app-navigation-entry__actions[data-v-995ba421], .app-navigation-entry:focus-within .app-navigation-entry__utils .app-navigation-entry__actions[data-v-995ba421], .app-navigation-entry:hover .app-navigation-entry__utils .app-navigation-entry__actions[data-v-995ba421] {\n  display: inline-block;\n}\n.app-navigation-entry.app-navigation-entry--deleted > ul[data-v-995ba421] {\n  display: none;\n}\n.app-navigation-entry:not(.app-navigation-entry--editing) .app-navigation-entry-link[data-v-995ba421], .app-navigation-entry:not(.app-navigation-entry--editing) .app-navigation-entry-button[data-v-995ba421] {\n  padding-inline-end: calc((var(--default-clickable-area) - 16px) / 2);\n}\n.app-navigation-entry .app-navigation-entry-link[data-v-995ba421], .app-navigation-entry .app-navigation-entry-button[data-v-995ba421] {\n  z-index: 100; /* above the bullet to allow click*/\n  display: flex;\n  overflow: hidden;\n  flex: 1 1 0;\n  min-height: var(--default-clickable-area);\n  padding: 0;\n  white-space: nowrap;\n  color: var(--color-main-text);\n  background-repeat: no-repeat;\n  background-position: calc((var(--default-clickable-area) - 16px) / 2) center;\n  background-size: 16px 16px;\n  line-height: var(--default-clickable-area);\n}\n.app-navigation-entry .app-navigation-entry-link .app-navigation-entry-icon[data-v-995ba421], .app-navigation-entry .app-navigation-entry-button .app-navigation-entry-icon[data-v-995ba421] {\n  display: flex;\n  align-items: center;\n  flex: 0 0 var(--default-clickable-area);\n  justify-content: center;\n  width: var(--default-clickable-area);\n  height: var(--default-clickable-area);\n  background-size: 16px 16px;\n  background-repeat: no-repeat;\n  background-position: calc((var(--default-clickable-area) - 16px) / 2) center;\n}\n.app-navigation-entry .app-navigation-entry-link .app-navigation-entry__name[data-v-995ba421], .app-navigation-entry .app-navigation-entry-button .app-navigation-entry__name[data-v-995ba421] {\n  overflow: hidden;\n  max-width: 100%;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n}\n.app-navigation-entry .app-navigation-entry-link .editingContainer[data-v-995ba421], .app-navigation-entry .app-navigation-entry-button .editingContainer[data-v-995ba421] {\n  width: calc(100% - var(--default-clickable-area));\n  margin: auto;\n}\n.app-navigation-entry .app-navigation-entry-link[data-v-995ba421]:focus-visible, .app-navigation-entry .app-navigation-entry-button[data-v-995ba421]:focus-visible {\n  box-shadow: 0 0 0 4px var(--color-main-background);\n  outline: 2px solid var(--color-main-text);\n  border-radius: var(--border-radius-element, var(--border-radius-pill));\n}\n\n/* Second level nesting for lists */\n.app-navigation-entry__children[data-v-995ba421] {\n  position: relative;\n  display: flex;\n  flex: 0 1 auto;\n  flex-direction: column;\n  width: 100%;\n  gap: var(--default-grid-baseline, 4px);\n}\n.app-navigation-entry__children .app-navigation-entry[data-v-995ba421] {\n  display: inline-flex;\n  flex-wrap: wrap;\n  padding-inline-start: 16px;\n}\n\n/* Deleted entries */\n.app-navigation-entry__deleted[data-v-995ba421] {\n  display: inline-flex;\n  flex: 1 1 0;\n  padding-inline-start: calc(var(--default-clickable-area) - (var(--default-clickable-area) - 16px) / 2) !important;\n}\n.app-navigation-entry__deleted .app-navigation-entry__deleted-description[data-v-995ba421] {\n  position: relative;\n  overflow: hidden;\n  flex: 1 1 0;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  line-height: var(--default-clickable-area);\n}\n\n/* counter and actions */\n.app-navigation-entry__utils[data-v-995ba421] {\n  display: flex;\n  min-width: var(--default-clickable-area);\n  align-items: center;\n  flex: 0 1 auto;\n  justify-content: flex-end;\n  /* counter */\n  /* actions */\n}\n.app-navigation-entry__utils.app-navigation-entry__utils--display-actions .action-item.app-navigation-entry__actions[data-v-995ba421] {\n  display: inline-block;\n}\n.app-navigation-entry__utils .app-navigation-entry__counter-wrapper[data-v-995ba421] {\n  margin-inline-end: calc(var(--default-grid-baseline) * 2);\n  display: flex;\n  align-items: center;\n  flex: 0 1 auto;\n}\n.app-navigation-entry__utils .action-item.app-navigation-entry__actions[data-v-995ba421] {\n  display: none;\n}\n\n/* editing state */\n.app-navigation-entry--editing .app-navigation-entry-edit[data-v-995ba421] {\n  z-index: 250;\n  opacity: 1;\n}\n\n/* deleted state */\n.app-navigation-entry--deleted .app-navigation-entry-deleted[data-v-995ba421] {\n  z-index: 250;\n  transform: translateX(0);\n}\n\n/* pinned state */\n.app-navigation-entry--pinned[data-v-995ba421] {\n  order: 2;\n  margin-top: auto;\n}\n.app-navigation-entry--pinned ~ .app-navigation-entry--pinned[data-v-995ba421] {\n  margin-top: 0;\n}\n[data-themes*=highcontrast] .app-navigation-entry[data-v-995ba421]:active {\n  background-color: var(--color-primary-element-light-hover) !important;\n}/**\n * SPDX-FileCopyrightText: 2019 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/**\n * SPDX-FileCopyrightText: 2021 Nextcloud GmbH and Nextcloud contributors\n * SPDX-License-Identifier: AGPL-3.0-or-later\n */\n/*\n* Ensure proper alignment of the vue material icons\n*/\n.material-design-icon[data-v-4def7aba] {\n  display: flex;\n  align-self: center;\n  justify-self: center;\n  align-items: center;\n  justify-content: center;\n}\n.app-navigation-input-confirm[data-v-4def7aba] {\n  flex: 1 0 100%;\n  width: 100%;\n}\n.app-navigation-input-confirm form[data-v-4def7aba] {\n  display: flex;\n}\n.app-navigation-input-confirm__input[data-v-4def7aba] {\n  height: 34px;\n  flex: 1 1 100%;\n  font-size: 100% !important;\n  margin: 5px !important;\n  margin-inline-start: -8px !important;\n  padding: 7px !important;\n}\n.app-navigation-input-confirm__input[data-v-4def7aba]:active, .app-navigation-input-confirm__input[data-v-4def7aba]:focus, .app-navigation-input-confirm__input[data-v-4def7aba]:hover {\n  outline: none;\n  background-color: var(--color-main-background);\n  color: var(--color-main-text);\n  border-color: var(--color-primary-element);\n}\n._container_1v0ql_2 {\n	margin-top: auto;\n	padding: var(--default-grid-baseline);\n}\n._header_1v0ql_7 {\n	margin-block: 0 var(--default-grid-baseline);\n	margin-inline: var(--default-grid-baseline);\n}\n._content_1v0ql_12 {\n	display: block;\n	padding: 10px;\n\n	/* prevent scrolled contents from stopping too early */\n	margin-bottom: calc(-1 * var(--default-grid-baseline));\n\n	/* restrict height of settings and make scrollable */\n	max-height: 300px;\n	overflow-y: auto;\n}\n._animationActive_1v0ql_24 {\n	transition-duration: var(--animation-slow);\n	transition-property: max-height, padding;\n	overflow-y: hidden !important;\n}\n._animationStop_1v0ql_30 {\n	max-height: 0 !important;\n	padding: 0 10px !important;\n}\n.app-activity .settings-link {\n  max-width: 100%;\n}\n.app-activity .app-navigation-entry.active .navigation-icon {\n  filter: var(--primary-invert-if-dark);\n}\n.app-activity .app-navigation-entry:not(.active) .navigation-icon {\n  filter: var(--background-invert-if-dark);\n}\n.app-activity .navigation-icon {\n  height: 16px;\n  width: 16px;\n}'));
...
import { r as register, _ as _export_sfc, t, N as NcButton, a as t29, l as loadState, u as useSwipe, i as isRtl, b as useRoute, c as useInfiniteScroll, d as cancelableClient, v, e as axios, f as t19, g as createFocusTrap, h as getTrapStack, j as t13, k as t46, m as t21, n as t20, o as createElementId, p as NcActions, q as onClickOutside, s as _, w as createRouter, x as createWebHistory } from "./index-BJ7ydZxs.chunk.mjs";
import { r as ref, a as readonly, b as resolveComponent, c as createElementBlock, d as createBlock, e as renderSlot, f as createBaseVNode, w as withDirectives, t as toDisplayString, g as createVNode, v as vShow, h as withCtx, i as createTextVNode, j as withModifiers, T as Teleport, n as normalizeClass, o as openBlock, k as defineComponent, l as createCommentVNode, m as mergeProps, u as useSlots, p as computed, q as watch, s as onMounted, x as onBeforeUnmount, y as provide, z as resolveDynamicComponent, A as inject, B as getCurrentInstance, C as normalizeStyle, D as unref, E as h, F as nextTick, G as Fragment, H as translate, I as renderList, J as warn, K as withKeys, L as vModelText, M as normalizeProps, N as guardReactiveProps, O as useTemplateRef, P as Transition, Q as createSlots, R as createApp } from "./translation-CD_FiYBO-CK2BqXfP.chunk.mjs";
import { e as emit, d as distExports, u as unsubscribe, s as subscribe } from "./index-KfUaQuGs.chunk.mjs";
import { N as NcIconSvgWrapper, l as logger, m as mdiArrowRight, A as ActivityComponent, a as moment, b as ActivityModel, c as NcEmptyContent, d as NcActionButton, e as NcInputField } from "./ActivityComponent-Dd9WZpZW.chunk.mjs";
import { _ as _export_sfc$1, N as NcLoadingIcon, a as NcCheckboxRadioSwitch } from "./NcCheckboxRadioSwitch-Ca1ouh22-BmLj0R_Y.chunk.mjs";
import { s as showError, a as showSuccess } from "./index-_4HphU9w-BvgcUyyz.chunk.mjs";
...
const _hoisted_3$a = { class: "vue-skip-actions__buttons" };
  ...
  return openBlock(), createElementBlock("div", {
    ...
    (openBlock(), createBlock(Teleport, { to: "#skip-actions" }, [
      createBaseVNode("div", _hoisted_1$f, [
        createBaseVNode("div", _hoisted_2$d, toDisplayString($options.t("Keyboard navigation help")), 1),
...
const NcContent = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render$h], ["__scopeId", "data-v-50a8547c"]]);
...
function _sfc_render$g(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock($setup["NcContent"], { "app-name": "extended_activity" }, {
    default: withCtx(() => [
...
const ActivityApp = /* @__PURE__ */ _export_sfc$1(_sfc_main$h, [["render", _sfc_render$g], ["__file", "/var/www/html/custom_apps/extended_activity/src/views/ActivityApp.vue"]]);
const _sfc_main$g = {
  name: "CloseIcon",
  emits: ["click"],
  props: {
...
const IconClose = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$f]]);
const Pe = {
  __name: "splitpanes",
  props: {
  ...
  setup(D) {
    ...
    const h2 = D, y = inject("requestUpdate"), u = inject("onPaneAdd"), E = inject("horizontal"), l = inject("onPaneRemove"), M = inject("onPaneClick"), m = (b = getCurrentInstance()) == null ? void 0 : b.uid, x = inject("indexedPanes"), S = computed(() => x.value[m]), c = ref(null), f = computed(() => {
      ...
      return Math.max(Math.min(r, R.value), _2.value);
    }), _2 = computed(() => {
    ...
    return watch(() => f.value, (r) => y({ uid: m, size: r })), watch(() => _2.value, (r) => y({ uid: m, min: r })), watch(() => R.value, (r) => y({ uid: m, max: r })), onMounted(() => {
      u({
        id: m,
        el: c.value,
        min: _2.value,
...
const _sfc_main$1$4 = /* @__PURE__ */ defineComponent({
  __name: "NcAppDetailsToggle",
  setup(__props) {
    const isMobile2 = useIsMobile();
    watch(isMobile2, toggleAppNavigationButton, { immediate: true });
    onBeforeUnmount(() => {
      if (isMobile2.value) {
...
const NcAppDetailsToggle = /* @__PURE__ */ _export_sfc(_sfc_main$1$4, [["__scopeId", "data-v-fd81a9f4"]]);
...
function _sfc_render$e(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_NcAppDetailsToggle = resolveComponent("NcAppDetailsToggle");
  ...
  return openBlock(), createElementBlock("main", {
    ...
    $props.pageHeading ? (openBlock(), createElementBlock("h1", _hoisted_1$d, toDisplayString($props.pageHeading), 1)) : createCommentVNode("", true),
    $data.hasList ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
      $setup.isMobile || $props.layout === "no-split" ? (openBlock(), createElementBlock("div", {
        ...
        $props.showDetails ? (openBlock(), createBlock(_component_NcAppDetailsToggle, {
          key: 0,
      ...
      ], 2)) : $props.layout === "vertical-split" || $props.layout === "horizontal-split" ? (openBlock(), createElementBlock("div", _hoisted_2$b, [
...
const NcAppContent = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$e], ["__scopeId", "data-v-3a1a29de"]]);
const _sfc_main$e = {
...
const ChevronDown = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$d]]);
const _sfc_main$d = {
  name: "ArrowRightIcon",
  emits: ["click"],
  props: {
...
const _hoisted_3$7 = { d: "M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z" };
...
const IconArrowRight = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$c]]);
...
const ActivityGroup = /* @__PURE__ */ _export_sfc$1(_sfc_main$c, [["render", _sfc_render$b], ["__scopeId", "data-v-c27bd1ea"], ["__file", "/var/www/html/custom_apps/extended_activity/src/components/ActivityGroup.vue"]]);
  ...
  setup(__props, { expose: __expose }) {
    ...
    async function loadActivities() {
      ...
      try {
        ...
        loading.value = true;
        const response = await cancelableClient.get(v("apps/extended_activity/api/v2/activity/{filter}?format=json&previews=true&since={since}", { filter: props.filter, since }));
    ...
    const __returned__ = { navigationList, route, props, loading, hasMoreActivites, allActivities, lastActivityLoaded, container: container2, groupedActivities, headingTitle, loadActivities, get t() {
      return translate;
    }, get NcAppContent() {
      return NcAppContent;
    }, get NcEmptyContent() {
...
const _hoisted_1$9 = { class: "extended_activity-app__heading" };
const _hoisted_2$8 = {
  ref: "container",
  class: "extended_activity-app__container"
};
const _hoisted_3$6 = {
  key: 1,
...
function _sfc_render$a(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock($setup["NcAppContent"], { class: "extended_activity-app" }, {
    default: withCtx(() => [
      createBaseVNode(
        "h1",
        _hoisted_1$9,
...
const ActivityAppFeed = /* @__PURE__ */ _export_sfc$1(_sfc_main$b, [["render", _sfc_render$a], ["__scopeId", "data-v-8f0835f4"], ["__file", "/var/www/html/custom_apps/extended_activity/src/views/ActivityAppFeed.vue"]]);
const _sfc_main$a = {
...
const NcAppNavigationList = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$9], ["__scopeId", "data-v-57437e4a"]]);
register(t19);
const _sfc_main$2$2 = {
  name: "MenuIcon",
  emits: ["click"],
...
const _hoisted_3$1$2 = { d: "M3,6H21V8H3V6M3,11H21V13H3V11M3,16H21V18H3V16Z" };
...
const MenuIcon = /* @__PURE__ */ _export_sfc(_sfc_main$2$2, [["render", _sfc_render$2$2]]);
const _sfc_main$1$3 = {
  name: "MenuOpenIcon",
  emits: ["click"],
  props: {
...
const _hoisted_3$5 = { d: "M21,15.61L19.59,17L14.58,12L19.59,7L21,8.39L17.44,12L21,15.61M3,6H16V8H3V6M3,13V11H13V13H3M3,18V16H16V18H3Z" };
...
const MenuOpenIcon = /* @__PURE__ */ _export_sfc(_sfc_main$1$3, [["render", _sfc_render$1$2]]);
const _sfc_main$9 = {
...
const _hoisted_1$7 = { class: "app-navigation-toggle-wrapper" };
function _sfc_render$8(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_MenuOpenIcon = resolveComponent("MenuOpenIcon");
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$7, [
    createVNode(_component_NcButton, {
      ...
      "aria-keyshortcuts": _ctx.disableKeyboardShortcuts ? "" : "n",
      "aria-label": $options.label,
      title: $options.label,
      onClick: $options.toggleNavigation
    }, {
      icon: withCtx(() => [
        $props.open ? (openBlock(), createBlock(_component_MenuOpenIcon, {
          key: 0,
          size: 20
        })) : (openBlock(), createBlock(_component_MenuIcon, {
          key: 1,
          size: 20
        }))
      ]),
      _: 1
    }, 8, ["aria-expanded", "aria-keyshortcuts", "aria-label", "title", "onClick"])
  ]);
}
const NcAppNavigationToggle = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$8], ["__scopeId", "data-v-e311a67a"]]);
const _sfc_main$8 = {
...
const _hoisted_1$6 = ["aria-hidden", "aria-label", "aria-labelledby", "inert"];
const _hoisted_2$6 = { class: "app-navigation__search" };
function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_NcAppNavigationList = resolveComponent("NcAppNavigationList");
  const _component_NcAppNavigationToggle = resolveComponent("NcAppNavigationToggle");
  return openBlock(), createElementBlock("div", {
    ref: "appNavigationContainer",
    class: normalizeClass(["app-navigation", { "app-navigation--close": !$data.open }])
  }, [
    createBaseVNode("nav", {
      id: "app-navigation-vue",
      "aria-hidden": $data.open ? "false" : "true",
      "aria-label": $props.ariaLabel || void 0,
      "aria-labelledby": $props.ariaLabelledby || void 0,
      class: "app-navigation__content",
      inert: !$data.open || void 0,
      onKeydown: _cache[0] || (_cache[0] = withKeys((...args) => $options.handleEsc && $options.handleEsc(...args), ["esc"]))
    }, [
      ...
      _ctx.$slots.list ? (openBlock(), createBlock(_component_NcAppNavigationList, {
        key: 0,
    ...
    createVNode(_component_NcAppNavigationToggle, {
      open: $data.open,
      "onUpdate:open": $options.toggleNavigation
    }, null, 8, ["open", "onUpdate:open"])
  ], 2);
}
const NcAppNavigation = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$7], ["__scopeId", "data-v-a249486e"]]);
const _sfc_main$7 = {
  name: "ChevronUpIcon",
  emits: ["click"],
  props: {
...
const _hoisted_3$4 = { d: "M7.41,15.41L12,10.83L16.59,15.41L18,14L12,8L6,14L7.41,15.41Z" };
...
const ChevronUp = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$6]]);
register(t13);
const _sfc_main$6 = {
...
const NcInputConfirmCancel = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__scopeId", "data-v-4def7aba"]]);
...
const NcAppNavigationIconCollapsible = /* @__PURE__ */ _export_sfc(_sfc_main$1$2, [["render", _sfc_render$1$1], ["__scopeId", "data-v-a22b5c4b"]]);
const _sfc_main$4 = {
...
const NcAppNavigationItem = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["__scopeId", "data-v-995ba421"]]);
register();
const _sfc_main$1$1 = {
  name: "CogIcon",
  emits: ["click"],
...
const IconCog = /* @__PURE__ */ _export_sfc(_sfc_main$1$1, [["render", _sfc_render$2]]);
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          createVNode(NcButton, {
            ...
            icon: withCtx(() => [
              createVNode(IconCog, { size: 20 })
            ]),
            default: withCtx(() => [
              createTextVNode(" " + toDisplayString(_ctx.name), 1)
            ]),
            _: 1
          }, 8, ["aria-controls", "aria-expanded"])
        ], 2),
...
const container = "_container_1v0ql_2";
const header = "_header_1v0ql_7";
const content = "_content_1v0ql_12";
const animationActive = "_animationActive_1v0ql_24";
const animationStop = "_animationStop_1v0ql_30";
const style0 = {
  container,
  header,
  content,
...
const IconContentCopy = /* @__PURE__ */ _export_sfc$1(_sfc_main$1, [["render", _sfc_render$1], ["__file", "/var/www/html/custom_apps/extended_activity/node_modules/vue-material-design-icons/ContentCopy.vue"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    async function toggleRSSLink() {
      try {
        const { data } = await cancelableClient.post(_("/apps/extended_activity/settings/feed"), {
...
const ActivityAppNavigation = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["render", _sfc_render], ["__file", "/var/www/html/custom_apps/extended_activity/src/views/ActivityAppNavigation.vue"]]);
const routes = [
  {
    path: "/",
    name: "root",
...
const router = createRouter({
  history: createWebHistory(_("/apps/extended_activity")),
...
app.use(router);
app.mount("#content");
//# sourceMappingURL=extended_activity-app.mjs.map
